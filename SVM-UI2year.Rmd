---
title: "SVM for urine loss 2-year"
...
# 
# 
#  saveRDS(svmProfile_linear, "C:/Users/hajar.hasannejadasl/Documents/prospect2022/models/SVMProfile-UI-2year.rds")
svmProfile_linear = readRDS("C:/Users/hajar.hasannejadasl/Documents/prospect2022/models/SVMProfile-UI-2year.rds")
```
...
# saveRDS(model_svmRFE, "C:/Users/hajar.hasannejadasl/Documents/prospect2022/models/model_svmRFE-2year.rds")


model_svmRFE = readRDS("C:/Users/hajar.hasannejadasl/Documents/prospect2022/models/model_svmRFE-2year.rds")

#Confusion matrix for train data
 predict_svmRFE_train<- predict(model_svmRFE, newdata = combined,na.action = na.pass)
 confusionMatrix(table(predict_svmRFE_train, SMOTE2BinaryOutcomeTraining))
...
#ROC plot
 train_prob = predict(model_svmRFE, SMOTE2TrainingSet, type = "prob")
 roc_svm_one <- roc(SMOTE2BinaryOutcomeTraining, as.vector(train_prob[,1]))
 plot(roc_svm_one, col = "black",lty = 1,cex.lab=1.5, cex.axis=1.5, lwd = 3, print.auc=TRUE)

#calibration plot
calibration_plot(SMOTE2OutcomeTraining, as.vector(train_prob[,1]))
...
roc_svm_one <- roc(BinaryoutcomeTest, as.vector(test_probSVM[,1]))
plot(roc_svm_one, col = "black",lty = 1,cex.lab=1.5, cex.axis=1.5, lwd = 3, print.auc=TRUE)
...
varimp_data2$feature2 <- c("Treatments","sCT","Leaking urine", "Urinary control", "Urinary function", "Urinate frequency","Urine loss", "Gleason group", "sCN")
