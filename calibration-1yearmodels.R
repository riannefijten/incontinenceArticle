...
source(knitr::purl("C:\\Users\\hajar.hasannejadasl\\Documents\\prospect2022\\FinalModels+calibration/UIRF-1-year.rmd"))

source(knitr::purl("C:\\Users\\hajar.hasannejadasl\\Documents\\prospect2022\\FinalModels+calibration/SVM-UI1year.rmd"))
...
CalTest$Source <- recode_factor(CalTest$Source, df1 = "Regression", df2 = "Forest", df3 = "Support")
...
CalTest %>%
  group_by(Source) %>%
  cal_plot_breaks(Class, Prob,num_breaks = 8) +
  theme_classic() +
  theme(legend.position = "top",legend.direction = "horizontal") +
  theme(text = element_text(size=15, face = "bold")) + 
  labs(y = "Predicted erectile dysfunction",x = "Observed erectile dysfunction") +
